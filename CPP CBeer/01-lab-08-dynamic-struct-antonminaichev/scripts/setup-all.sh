...
DEBIAN_PACKAGES="build-essential cmake git libgtest-dev libgmock-dev gcovr python3 python3-pip"
...
FEDORA_PACKAGES="cmake gcc gcc-c++ git gtest gmock gcovr python3 python3-pip"
ARCH_PACKAGES="base-devel clang cmake gtest git gcovr python3 python-pip"
